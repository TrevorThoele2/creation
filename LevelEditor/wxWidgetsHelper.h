...
namespace Creation
{
    ...
    WindowT* CreateStaticBox(wxWindow *parent, wxWindowID id, const std::string &label, wxSizer *sizerAddBoxTo, int proportion = 0, int flags = 0, int border = 0, bool expandWindow = true)
    {
    ...
    WindowT* CreateStaticBox(wxWindow *parent, wxWindowID id, const std::string &label, wxSizer *sizerAddBoxTo, int proportion, int flags, int border, bool expandWindow, Args && ... args)
    {
        auto box = new wxStaticBoxSizer(new wxStaticBox(parent, wxID_ANY, label), wxVERTICAL);
        sizerAddBoxTo->Add(box, proportion, flags, border);
    ...
    {
        wxOrientation useDirection;
        switch (primaryDirection)
        {
        case Direction::HORIZONTAL:
            useDirection = wxOrientation::wxVERTICAL;
            break;
        case Direction::VERTICAL:
            useDirection = wxOrientation::wxHORIZONTAL;
            break;
        }
